      ...
      <header>
        <section className={classes.headerSection}>
          ...
          <div className={classes.dropdown}>
            <span className={classes.headerLink} onClick={toggleProduction}>
              {isProductionOpen ? "Продукция ⬆️" : "Продукция ⬇️"}
            </span>
            {isProductionOpen && (
          ...
          {/* Компания */}
          <div className={classes.dropdown}>
            <span className={classes.headerLink} onClick={toggleCompany}>
              {isCompanyOpen ? "Компания ⬆️" : "Компания ⬇️"}
            </span>
            {isCompanyOpen && (
              <div className={classes.dropdownContent}>
